...
{
	/// <summary>
	/// Represents an ActXmlParser type, used to manipulate XML data from a file.
	/// </summary>
	public class ActXmlParser : XmlParser
	{
		/// <summary>
		/// Constructs a new ActXmlParser object.
		/// </summary>
		...
		protected override void OnParse(string fileName, List<Crime> crimes)
		{
			...
			State state = StateRepository.GetStateByAbbreviatedName(ACT);
