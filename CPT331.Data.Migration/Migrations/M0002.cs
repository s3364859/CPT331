	...
	public class M0002 : FluentMigrator.Migration
	{
		...
		public override void Up()
		{
            ...
            Insert.IntoTable("Offence").InSchema("Crime")
				...
				.Row(new { Name = "Breach Of Restraint Order" })
				...
				.Row(new { Name = "Burglary (Dwelling)" })
				.Row(new { Name = "Burglary (Non-Dwelling)" })
				...
				.Row(new { Name = "Dangerous Or Negligent Acts Endangering Persons" })
				...
				.Row(new { Name = "Deprivation Of Liberty" })
				...
				.Row(new { Name = "Drugs (Possess)" })
				.Row(new { Name = "Drugs (Traffic)" })
				...
				.Row(new { Name = "Fraud" })
				.Row(new { Name = "Fraud, Deception And Related Offences" })
				...
				.Row(new { Name = "Historical Sexual Assault" })
				...
				.Row(new { Name = "Illicit Drug Offences" })
				...
				.Row(new { Name = "Non-Domestic Assault" })
				.Row(new { Name = "Non-Domestic Violence Related Assault" })
				.Row(new { Name = "Offences Against A Person" })
				.Row(new { Name = "Offences Against Justice Procedures, Government Security And Operations" })
				...
				.Row(new { Name = "Prohibited And Regulated Weapons And Explosives Offences" })
				...
				.Row(new { Name = "Property Damage And Environmental Pollution" })
				...
				.Row(new { Name = "Recent Sexual Assault" })
				...
				.Row(new { Name = "Robbery (Business)" })
				.Row(new { Name = "Robbery (Non-Business)" })
				...
				.Row(new { Name = "Theft And Related Offences" })
				...
				.Row(new { Name = "Traffic And Vehicle Regulatory Offences" })
				.Row(new { Name = "Traffic Infringements" })
				...
				.Row(new { Name = "Unlawful Entry With Intent" })
